"""Hugging Face 동작 라이브러리 재생 예제 (원본 스타일).

실행 예시:
    # 기본 dance 라이브러리 반복 재생
    python recorded_moves_origin.py -l dance

    # emotions 라이브러리 반복 재생
    python recorded_moves_origin.py -l emotions

    # 커스텀 HF dataset id 직접 지정
    python recorded_moves_origin.py --dataset "pollen-robotics/reachy-mini-dances-library"
"""
